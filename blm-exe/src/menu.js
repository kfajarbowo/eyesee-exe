            ...
            submenu: [
                {
                    ...
                    click: () => {
                        if (mainWindow) mainWindow.webContents.send('webview-go-back');
                    },
                },
                {
                    label: 'Forward',
                    ...
                    click: () => {
                        if (mainWindow) mainWindow.webContents.send('webview-go-forward');
                    },
                },
                {
                    label: 'Home',
                    ...
                    click: () => {
                        if (mainWindow) mainWindow.webContents.send('webview-go-home');
                    },
                },
            ],
        },
                ...
                { type: 'separator' },
                {
                    ...
                    click: () => {
                        showAboutDialog(mainWindow, {
                            appName: 'BLM',
                            productName: 'BLM Webview Application',
                            version: app.getVersion() || '1.0.0',
                            iconPath: path.join(__dirname, '../assets/icons/png/logo-blm.png')
                        });
                    },
                },
            ],
