...
function getLicenseStoragePath() {
    ...
    const appNames = ['blm-webview', 'BLM Webview Application', 'blm-exe', 'BLM'];
    const storeNames = ['blm-license', 'config'];
...
function main() {
    ...
    console.log('\n╔══════════════════════════════════════════════════════════════════╗');
    console.log('║                    BLM License Admin Tool                        ║');
    console.log('╚══════════════════════════════════════════════════════════════════╝');
