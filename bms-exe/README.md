...
> Simple Electron application to create a webview

This is a simple Electron application to create a webview based on the template from [electron-webview](https://github.com/hajidalakhtar/electron-webview).
