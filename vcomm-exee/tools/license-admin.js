...
function getLicenseStoragePath() {
    ...
    const appNames = ['electron-webview', 'VComm Application', 'vcomm-exee', 'VComm'];
    const storeNames = ['vcomm-license', 'config'];
...
function main() {
    ...
    console.log('\n╔══════════════════════════════════════════════════════════════════╗');
    console.log('║                    VComm License Admin Tool                      ║');
    console.log('╚══════════════════════════════════════════════════════════════════╝');
